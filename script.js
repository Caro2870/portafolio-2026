const translations = {
  en: {
    ...
    "nav.repos": "Repos",
    "nav.contact": "Contact",
    "ctaBanner.text": "Available for senior backend/full-stack roles and high-impact product builds.",
    "ctaBanner.button": "Book a call",
    ...
    "profile.signatureLabel": "ENGINEERING STYLE",
    "profile.signature": "Build real systems that solve real business problems.",
    ...
    "cases.title": "Business outcomes",
    "cases.one.tag": "SERVERLESS + ANALYTICS",
    "cases.one.title": "HR Metrics Pipeline",
    "cases.one.body": "Designed event-driven pipeline for enterprise HR insights and faster reporting cycles.",
    "cases.one.kpi1": "Problem: delayed reporting and low visibility.",
    "cases.one.kpi2": "Action: serverless + event-driven architecture on AWS.",
    "cases.one.kpi3": "Result: -70% reporting latency and near real-time insights.",
    "cases.two.tag": "MONOLITH TO MICROSERVICES",
    "cases.two.title": "Symfony Migration",
    "cases.two.body": "Migration to Node.js services with DDD + Hexagonal architecture and shared logging SDK.",
    "cases.two.kpi1": "Problem: monolith bottlenecks and risky deployments.",
    "cases.two.kpi2": "Action: service split with DDD + Hexagonal design.",
    "cases.two.kpi3": "Result: faster delivery cycles and lower deploy risk.",
    "cases.three.tag": "AI INTEGRATION",
    "cases.three.title": "Production AI Features",
    "cases.three.body": "Integrated generative AI into enterprise workflows with guardrails and practical business use.",
    "cases.three.kpi1": "Problem: repetitive manual tasks in operations.",
    "cases.three.kpi2": "Action: AI assistants with guardrails + prompt strategy.",
    "cases.three.kpi3": "Result: measurable productivity gains and automation.",
    ...
    "repos.eyebrow": "FEATURED REPOSITORIES",
    "repos.title": "Code samples and live projects",
    "repos.finanzas": "Full-stack app with multi-tenant finance tracking and production deploy setup.",
    "repos.profile": "Explore more repositories, experiments and architecture work.",
    "repos.live": "Live environments for finance and ecommerce running in production.",
    "repos.view": "View repository",
    "repos.viewLive": "Open live app",
    ...
    "contact.subline": "CV and detailed case studies available on request.",
  ...
  es: {
    ...
    "ctaBanner.text": "Disponible para roles senior backend/full stack y construcción de productos de alto impacto.",
    "ctaBanner.button": "Agendar llamada",
    ...
    "profile.signatureLabel": "ESTILO DE INGENIERÍA",
    "profile.signature": "Construir sistemas reales que resuelvan problemas reales de negocio.",
    ...
    "cases.title": "Resultados de negocio",
    "cases.one.tag": "SERVERLESS + ANALÍTICA",
    "cases.one.title": "Pipeline de métricas de RRHH",
    "cases.one.body": "Diseñé un pipeline event-driven para insights empresariales y ciclos de reporte más rápidos.",
    "cases.one.kpi1": "Problema: reportes lentos y poca visibilidad.",
    "cases.one.kpi2": "Acción: arquitectura serverless + event-driven en AWS.",
    "cases.one.kpi3": "Resultado: -70% en latencia y métricas casi en tiempo real.",
    "cases.two.tag": "MONOLITO A MICROSERVICIOS",
    "cases.two.title": "Migración Symfony",
    "cases.two.body": "Migración a servicios Node.js con DDD + Arquitectura Hexagonal y SDK de logging compartido.",
    "cases.two.kpi1": "Problema: cuello de botella monolítico y despliegues riesgosos.",
    "cases.two.kpi2": "Acción: separación de servicios con DDD + Hexagonal.",
    "cases.two.kpi3": "Resultado: ciclos más rápidos y menor riesgo en despliegues.",
    "cases.three.tag": "INTEGRACIÓN IA",
    "cases.three.title": "Funciones IA en producción",
    "cases.three.body": "Integré IA generativa en flujos empresariales con guardrails y uso práctico de negocio.",
    "cases.three.kpi1": "Problema: tareas manuales repetitivas en operación.",
    "cases.three.kpi2": "Acción: asistentes IA con guardrails + estrategia de prompts.",
    "cases.three.kpi3": "Resultado: mejora medible de productividad y automatización.",
    ...
    "repos.eyebrow": "REPOSITORIOS DESTACADOS",
    "repos.title": "Muestras de código y proyectos en vivo",
    "repos.finanzas": "Aplicación full stack con finanzas multi-tenant y despliegue productivo.",
    "repos.profile": "Explora más repositorios, experimentos y trabajo de arquitectura.",
    "repos.live": "Entornos en vivo para finanzas y ecommerce en producción.",
    "repos.view": "Ver repositorio",
    "repos.viewLive": "Abrir app en vivo",
    ...
    "contact.subline": "CV y casos de estudio detallados disponibles bajo solicitud.",
